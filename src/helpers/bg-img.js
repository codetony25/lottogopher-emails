...
module.exports = function(options) {
  ...
  // HTML Output
  var bg = '\
    <table align="center" class="bulletproof-bg ' + classes + '" border="0" cellpadding="0" cellspacing="0" width="100%" style="font-size:1px !important; line-height:0 !important; mso-margin-top-alt:0px !important; vertical-align: top;">\
      <tr valign="top">\
        <td class="main-bg" background="' + src + '" bgcolor="' + bgcolor + '" valign="top" align="center" style="height: ' + imgheight + 'px;' + ' text-align: center; background-repeat: no-repeat !important; vertical-align: middle;">\
          <!--[if gte mso 9]>\
